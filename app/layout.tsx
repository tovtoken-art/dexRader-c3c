        ...
        <header className="w-full border-b border-neutral-200 dark:border-neutral-700">
          <div className="container flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* DexScreener 아이콘 버튼 */}
              <a
                href="https://dexscreener.com/solana/C3CXrNCw5r9GwUrnMSjMwe3QTKkBjnvQCG3cLx1naSZK"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center p-1 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-700"
                aria-label="Open DexScreener pair"
              >
                <div className="text-xs text-neutral-400">DexScreener 차트보기</div>
                <svg
